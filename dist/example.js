...
$templateCache.put("views/copilot-messaging.html","<button ng-click=\"vm.back()\">Back</button><h1 class=\"messaging-page-header\">Messages with Customer</h1><messaging thread-id=\"{{ vm.threadId }}\" subscriber-id=\"{{ vm.subscriberId }}\"></messaging>");

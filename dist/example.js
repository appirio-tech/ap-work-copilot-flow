...
$templateCache.put("views/copilot-messaging-view.html","<a ng-click=\"vm.back()\">Back</a><h1 class=\"messaging-page-header\">Messaging ThreadId: {{vm.threadId}} SubscriberId: {{vm.subscriberId}}</h1><messaging thread-id=\"{{ vm.threadId }}\" subscriber-id=\"{{ vm.subscriberId }}\"></messaging>");

...
(function () {
  ...
  SubmitBriefController.$inject = ['$scope', 'logger', '$state', 'ClaimProjectService', 'NavService'];
  /* @ngInject */
  function SubmitBriefController($scope, logger, $state, ClaimProjectService, NavService) {
    var vm           = this;
    vm.title         = 'Brief';
